...
export const About = () => {
  return (
    <section className="bg-zinc-800 py-10 flex flex-col gap-5 items-center">

      <h2 className="font-bold text-[50px] leading-[1.15]">Sobre o app</h2>
      <p className="text-zinc-500 text-sm w-[40rem] text-center">Wealt foi cuidadosamente desenvolvido para  simplificar sua vida, oferecendo uma variedade de ferramentas para auxiliá-lo, tudo em uma plataforma unificada. Com o FinançasMestras, você pode acompanhar e gerenciar sua   riqueza de maneira simples e eficaz, ajudando-o a tomar decisões financeiras informadas. Assuma o controle total   de suas finanças!</p>
